...
# Crontab: @reboot /home/pi/appliancemon/mjpg-streamer.sh start
#
#
# *** Modified for Appliance Monitor ***
#
#

MJPG_STREAMER_BIN="/usr/local/bin/mjpg_streamer"  # "$(dirname $0)/mjpg_streamer"
MJPG_STREAMER_WWW="/usr/local/share/mjpg-streamer/www"
MJPG_STREAMER_LOG_FILE="/ram/mjpg-streamer.log"  # "$(dirname $0)/mjpg-streamer.log"
